...
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider adding the 'required' modifier or declaring as nullable.
    ...
    public static unsafe void Init()
    {
        ...
        _cbv = MyManagers.Buffers.CreateConstantBuffer("Prism.Billboard.FrameConstants", sizeof(FrameConstants) + sizeof(float4x4) * 33, usage: ResourceUsage.Dynamic, isGlobal: true);
        ...
        {
            _indices = MyManagers.Buffers.CreateIndexBuffer("Prism.Billboard.Indices", 6, (IntPtr)ptr, MyIndexBufferFormat.UShort, ResourceUsage.Immutable, true);
        }
    ...
    public static int Align(int unaligned, int alignment)
    {
        checked
        {
    ...
    [HarmonyPrefix]
    public static bool RenderAdditiveBottom_Prefix(MyRenderContext rc, ISrvBindable depthRead)
    {
    ...
    [HarmonyPrefix]
    public static bool RenderAdditiveTop_Prefix(MyRenderContext rc)
    {
        rc.SetBlendState(MyBlendStateManager.BlendAdditive);
    ...
    [HarmonyPrefix]
    public static bool RenderLDR_Prefix(MyRenderContext rc, ISrvBindable depthRead, IRtvBindable target)
    {
    ...
    [HarmonyPrefix]
    public static bool RenderPostPP_Prefix(MyRenderContext rc, ISrvBindable depthRead, IRtvBindable target)
    {
        rc.SetViewport(0f, 0f, target.Size.X, target.Size.Y);
        rc.SetBlendState(MyBlendStateManager.BlendAlphaPremult);
        rc.SetDepthStencilState(MyDepthStencilStateManager.DefaultDepthState);
    ...
    [HarmonyPrefix]
    public static bool RenderStandard_Prefix(MyRenderContext rc, ISrvBindable depthRead)
    {
        rc.SetDepthStencilState(MyDepthStencilStateManager.DefaultDepthState);
        rc.SetScreenViewport();
